                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="flex w-full md:w-auto mt-4 md:mt-0">
                    <a href="#contact" className="relative inline-flex w-full md:w-auto">
                      ...
                      <button className="relative inline-flex items-center justify-center w-full px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-bold text-white bg-slate-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
